...
#
    ...
    for i, result in enumerate(results):
        ...
        result.overlaid_corner(bilby_samples, ['NS', 'NF'], filename="overlaid_corner_plot_full_v2.png", units=units)
        result.overlaid_corner(bilby_samples, ['NS', 'NF'], filename="overlaid_corner_plot_prior_bounds_full_v2.png", prior_bounds=prior_bounds, units=units)
