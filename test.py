...
bilby_location = None
flow_location = '/data/www.astro/2263373r/giflow/4_paper/parameterised/different_data_sizes/run_2024-08-04 10:12:11.450115/'
...
df = pd.DataFrame(data=kl)
df.to_csv(os.path.join(flow_location, 'kl_statistics.csv'))
