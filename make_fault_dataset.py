...
save = '/scratch/balta0/2263373r/fault_python/synthetic_inversion_data/'
...
model_framework = {
    "type": 'parameterised',
    'default_parameters': {'density': 800.0, 'DL_ratio': 0.02, 'dip': 70*np.pi/180, 'Blend_order': 1.2, 'Displacement_order': 1.2, 'Extent_ratio': 1.5, 'sym_factor': 0.2},
...
#  model_framework = model_framework
#)
#dt_train.make_dataset(augment=False, augment_dims=['density'], augment_num=10, window=True, zero_pad=True, num_components=50)
